# Ensembled Forward Selection (EFS)

A research framework for Ensembled Forward Selection algorithms with comprehensive simulation and comparison tools.
...
├── efs_experiments/      # Experiments package
│   └── src/efs_experiments/
│       ├── simulation/   # Simulation utilities
│       ├── plotting/     # Plotting functions
│       └── utils/        # SNR and other utilities
├── efs/                  # Core EFS algorithm package
...
2. **Install packages:**
```bash
# Install core EFS package
pip install ./efs

# Install experiments package  
pip install ./efs_experiments
```
...
```python
from efs import EFSCV
from efs.penalized_score import create_penalized_scorer
...
```python
from efs_experiments.utils.sim_util_dgs import (
    generate_banded_X,
...
```python
from efs_experiments.utils.snr_utils import (

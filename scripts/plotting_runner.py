...
from efs_experiments.plotting.plotting import *
from efs_experiments.utils.snr_utils import get_signal_strength_from_results, compute_snr

def parse_labels_string(labels_str: str) -> Dict[str, List[int]]:
    """Parse labels string from command line format.
    
    Expected format: "EFS:1,20;FS:1,10,20" or "EFS=[1,20];FS=[1,10,20]"
    """
        ...
        try:
            ...
            for sigma in sigma_values:
                ...
                plot_mse_vs_df_by_k(
                    ...
                    save_path=save_path, 
                    show_std=show_std, 
                    method_filter=lambda m: m in ['efs', 'original_fs', 'fs'],
                    labels=labels
                )
            ...
            try:
                ...
                if 'df' in plot_name:
                    ...
                    def filtered_plot_func(*args, **kwargs):
                        ...
                        kwargs['method_filter'] = lambda m: m in ['efs', 'original_fs']
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate plots for EFS simulation results')
    ...
    parser.add_argument('--labels', type=str, default=None,
                      help='Specify which k values to label for MSE vs DF plots. Format: "EFS:1,20;FS:1,10,20" or "EFS=[1,20];FS=[1,10,20]". Use empty string or "none" for no labels.')

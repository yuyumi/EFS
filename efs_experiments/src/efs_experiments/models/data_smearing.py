...
class SmearedFS(BaseEstimator, RegressorMixin):
    """
    Data Smearing with EFS (m=p, B=1) and CV for optimal k and noise scale.
    ...
    def _fit_individual_fs(self, X, y, noise_scale, random_state=None):

...
class PlottingConfig:
    ...
    COLORS = {
        ...
        'base_fs': '#E74C3C',
        'original_fs': '#D35400',
        'fs': '#D35400',  # Same color as original_fs since they're the same method
        'efs': '#F8C471'
    }
    ...
    METHODS = ['lasso', 'elastic', 'bagged_fs', 'smeared_fs', 'original_fs', 'fs', 'efs']
    ...
    METHOD_LABELS = {
        ...
        'elastic': 'Elastic',
        'bagged_fs': 'Bagged FS',
        'smeared_fs': 'Smeared FS',
        'base_efs': 'Base EFS',
        'base_fs': 'Base FS',
        'original_fs': 'FS',
        'fs': 'FS',  # Same label as original_fs
        'efs': 'EFS'
    }
...
def plot_mse_vs_df_by_k(results_path: Path, target_snr: float, save_path: Optional[Path] = None,
    ...
    Args:
        labels: Optional dict mapping method names to lists of k values to label.
                Method names should be display names like 'EFS', 'FS'. 
                Example: {'EFS': [1, 20], 'FS': [1, 10, 20]}
    ...
    try:
        ...
        # Explicitly filter to only original_fs/fs and efs methods for MSE vs DF by k plots
        target_methods = ['original_fs', 'fs', 'efs']
        ...
        method_markers = {'lasso': 'o', 'elastic': 's', 'bagged_fs': 'v', 
                         'smeared_fs': '^', 'original_fs': 'D', 'efs': '*'}
        ...
        for method in available_methods:
            ...
            for i, k in enumerate(k_values):
                ...
                if method in ['fs', 'original_fs']:
                    # Default: FS labels to the right
                    default_side = 'right'
                    base_offset = (12, 0)
                    ...
                    # Default: EFS labels to the left
                    default_side = 'left'
        ...
        if log_scale_mse:
            ...
            if all_mse_values:
                ...
                x_range = x_max - x_min
                # Add extra padding: 12% on left for EFS labels, 15% on right for FS labels

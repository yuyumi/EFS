...
- `calculate_df_for_all_k()` - DF for each k value in EFS models
- `calculate_df_for_all_k_ensemble()` - DF for each k value in ensemble models
- `calculate_mse_for_all_k()` - MSE for each k value in EFS models
- `calculate_insample_for_all_k()` - In-sample error for each k value in EFS models
